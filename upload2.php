...
$buildingMaterial = clean_input($_POST['buildingMaterial'] ?? '');
...
try {
    ...
    $stmt = $conn->prepare("INSERT INTO building_material 
    ...
    echo "Success: Building material uploaded and publish entry created.";
