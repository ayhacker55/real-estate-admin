...
<section class="w3-content w3-white w3-padding w3-card" style="max-width: 800px; margin:auto; margin-top: 20px;">
  ...
  <form id="adminForm" enctype="multipart/form-data">
    ...
    <label>Surname</label>
    <input class="w3-input w3-border w3-round" type="text" name="surname" required>
...
<div class="w3-input w3-border w3-round" style="position: relative;">
  <input type="password" name="password" id="password" style="width: 100%; padding-right: 40px;" required>
  <span onclick="togglePassword()" style="position: absolute; top: 8px; right: 10px; cursor: pointer;">
    👁️
  </span>
</div>
    <!-- Profile Photo -->
    ...
    <div id="photoPreviewContainer" class="w3-margin-top" style="display: none;">
      <img id="photoPreview" src="" alt="Preview" style="max-width: 150px; height: auto; border: 1px solid #ccc; padding: 5px;">
      <br>
      <button type="button" class="w3-button w3-red w3-small w3-round w3-margin-top" onclick="removePhoto()">Remove Photo</button>
    </div>

    <button type="submit" class="w3-button w3-blue w3-round w3-margin-top">Create Admin</button>
  </form>
</section>
