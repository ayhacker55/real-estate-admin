...
// Get total records
$total_result = mysqli_query($db, "SELECT COUNT(*) as total FROM building_material $where");
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="edit_material.php?id=<?= $row['id'] ?>"><i class="fa fa-pencil"></i> Edit</a></li>
                        <li><a href="delete_material.php?id=<?= $row['id'] ?>" onclick="return confirm('Delete this material?')"><i class="fa fa-trash text-danger"></i> Delete</a></li>
                        <li><a href="approve_material.php?id=<?= $row['id'] ?>"><i class="fa fa-check text-success"></i> Approve</a></li>
                        <li><a href="reject_material.php?id=<?= $row['id'] ?>"><i class="fa fa-times text-danger"></i> Reject</a></li>
                      </ul>
                    </div>
                  </td>
                </tr>
