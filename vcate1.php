...
$total_result = mysqli_query($db, "SELECT COUNT(*) as total FROM category");
$total_row = mysqli_fetch_assoc($total_result);
$total_categories = $total_row['total'];
$total_pages = ceil($total_categories / $limit);

// Fetch paginated categories
$query = "SELECT id, cate FROM category ORDER BY id DESC LIMIT $offset, $limit";
      ...
      <tbody>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          echo "<tr>
                  ...
                  <td>{$row['cate']}</td>
                  <td>
                    <a href='delete_category.php?id={$row['id']}' onclick='return confirm(\"Are you sure?\")'>
