            ...
            <tbody>
              ...
              <?php while ($row = mysqli_fetch_assoc($result)):
                ...
                <tr>
                  ...
                  <td>
                    <?php if ($image): ?>
                      <img src="upload/<?= htmlspecialchars($image) ?>" style="width: 100px; height: 70px; object-fit: cover;">
                    <?php else: ?>
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a href="approve_property.php?id=<?= $row['id'] ?>"><i class="fa fa-check text-success"></i> Approve</a></li>
                        <li><a href="reject_property.php?id=<?= $row['id'] ?>"><i class="fa fa-times text-danger"></i> Reject</a></li>
                      </ul>
                    </div>
                  </td>
                </tr>
